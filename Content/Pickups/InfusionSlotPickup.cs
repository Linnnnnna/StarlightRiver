...
namespace StarlightRiver.Content.Pickups
{
	class InfusionSlotPickup : AbilityPickup
	{
		...
		public override void PickupVisuals(int timer)
		{
			...
			if (timer == 559)
			{
				UILoader.GetUIState<TextCard>().Display(Language.GetTextValue("Mods.StarlightRiver.NPCs.InfusionSlotPickup.DisplayText"), Language.GetTextValue("Mods.StarlightRiver.NPCs.InfusionSlotPickup.DisplayText2"), time: 360);
